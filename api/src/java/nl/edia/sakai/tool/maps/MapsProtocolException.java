...
/**
 * Thrown to indicate a client error in the protocol.
 * 
 * @author Maarten van Hoof
 *
 */
public class MapsProtocolException extends Exception {


	private static final long serialVersionUID = -5585589187291211210L;
	 ...
	 * @param message
	 */
	public MapsProtocolException(String type, String message) {
		super(message);
		this.type = type;
	}
	 ...
	 * @param thrown
	 */
	public MapsProtocolException(Throwable thrown) {
		super(thrown);
	}
	 ...
	 * @param thrown
	 */
	public MapsProtocolException(String type, String message, Throwable thrown) {
