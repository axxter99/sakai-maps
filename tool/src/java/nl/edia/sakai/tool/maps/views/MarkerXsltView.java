...
/**
 * Displays an XML view for only a single marker.
 * @author Roland
 *
 */
public class MarkerXsltView extends AbstractMarkerXsltView  {
	...
	protected Source createXsltSource(Map model, String root,
		...
		Element myElement = createMarkerElement(marker);
		
		return createDocSource(myElement);
	}
