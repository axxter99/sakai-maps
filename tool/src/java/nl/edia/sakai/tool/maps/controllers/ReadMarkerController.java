 ...
 *
 */
public class ReadMarkerController extends MarkerController {
	...
	/**
	 * Read the marker with the requested element from the database and return the model
	 * @see nl.edia.sakai.tool.maps.controllers.MarkerController#processRequest(javax.servlet.http.HttpServletRequest)
	 */
	@Override
	public Map<String, Object> processRequest(HttpServletRequest request) throws MapsProtocolException,	PermissionException, IdUnusedException {
		Long id = getIdParameter(request);
		Marker marker = markerService.readMarker(id);
