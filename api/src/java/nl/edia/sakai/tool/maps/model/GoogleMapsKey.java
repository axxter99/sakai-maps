...
/**
 * A representation of a GoogleMaps Key.
 * @author Maarten van Hoof
 *
 */
public class GoogleMapsKey extends AbstractLongIdEntity {
	...
	/**
	 * Returns the URL for this key. The url may be null or empty if there
	 * is only a single key or if this is the default key.
	 * @return the url
	 */
	...
	/**
	 * Returns the actual google maps key.
	 * @return the key
	 */
