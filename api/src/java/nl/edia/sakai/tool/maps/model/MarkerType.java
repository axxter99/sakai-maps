...
public class MarkerType extends AbstractLongIdEntity {
	...
	/**
	 * The id for the context the marker type is located in, this can be referred
	...
	/**
	 * Inverse mapped set of markers, do not update, read only.
	 */
	 ...
	 * @param name
	 */
	public MarkerType(String imageNumber, String name) {
		super();
	...
	public void setImage(String imageNumber) {
		this.image = imageNumber;
	}
	...
	public void copyProps(MarkerType markerType) {
		image = markerType.image;
		name = markerType.name;
		context = markerType.context;
	}
