 ...
 *
 */
public class ListMarkerTypesController extends MarkerController {
	...
	public Map<String, Object> processRequest(HttpServletRequest request) throws MapsProtocolException, PermissionException {
		List<MarkerType> markers = markerService.listMarkerTypes();

		return createModel("markertypes", markers);
	}
