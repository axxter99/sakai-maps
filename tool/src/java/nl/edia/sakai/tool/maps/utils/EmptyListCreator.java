...
public class EmptyListCreator<E>  {
	
	/**
	 * Gets a list of empty intantiated elements
	 * @param request
	 * @return
	 * @throws IllegalAccessException 
	 * @throws InstantiationException 
	 */
	public List<E> getEmptyList(int size, Class<E> clazz) throws InstantiationException, IllegalAccessException {
